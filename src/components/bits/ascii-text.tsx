...
class CanvAscii {
  ...
  async init() {
    try {
      await document.fonts.load('600 200px JetBrains Mono').catch(() => {});
      await document.fonts.load('500 12px JetBrains Mono').catch(() => {});
    } catch (e) {}
...
export function ASCIIText({
  ...
  return (
    <div
      ref={containerRef}
      className="ascii-text-container relative h-full w-full"
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #f3f3f3 0%, #c1c1c1 45%, #6f6759 100%);
